    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-black to-gray-900 text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-md">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold">AI ChatBot</Link>
          <div className="hidden md:flex space-x-4">
            <Link href="#features" className="hover:text-primary transition-colors">Features</Link>
            <Link href="#reviews" className="hover:text-primary transition-colors">Reviews</Link>
            <Link href="#cta" className="hover:text-primary transition-colors">Get Started</Link>
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 py-20">
          ...
          <div className="z-10 text-center mb-12 max-w-[80vw] pt-40">
            ...
            <p className="text-lg text-gray-300 mb-8 px-4">
              Unlock the power of AI-driven communication. Get instant, smart responses 
        ...
        <section id="reviews" className="py-20 bg-gradient-to-r from-primary to-primary-dark">
          <div className="container mx-auto px-4">
        ...
        <section id="cta" className="py-20 bg-gradient-to-b from-black to-gray-900">
          <div className="container mx-auto text-center px-4">
            ...
            <p className="text-xl mb-8">Experience the power of AI-driven conversations today!</p>
